...
import ProfilePic from '../assets/rohit_gupta_pic.jpeg';
// or
...
const HomePage = () => {
  ...
  return (
      ...
      {/* <section className="bg-gradient-to-br from-blue-50 to-indigo-50 py-20">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/3 flex flex-col items-center">
            ...
            <p className="mt-4 text-gray-600 font-medium">Built by Lalit Kumar Yadav</p>
          </div>
        </div>
      </section> */}
    ...
    <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between relative z-10">
        ...
        <p className="mt-4 text-gray-700 font-semibold drop-shadow animate-fade-in-up animation-delay-500">Built by Rohit Gupta</p>
        </div>
    </div>
    </section>
